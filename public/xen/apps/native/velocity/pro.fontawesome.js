  ...
  (function (t) {
    ...
    function E(t, e) {
      var n = e.fetch,
        ...
        r = (e.token, t);
      return (
        (r = "URLSearchParams" in window ? new URL(t) : r.toString()),
        new F(function (t, e) {
          if ("function" == typeof n)
            n(r, { mode: "cors", cache: "default" })
              .then(function (t) {
    ...
    try {
      if (window.FontAwesomeKitConfig) {
        var k = window.FontAwesomeKitConfig,
          ...
          I = T ? T.parentElement : document.head;
        (function () {
          var t =
          ...
          return "js" === t.method
            ? (function (t, e) {
                ...
                return (
                  ...
                  n.push(
                    new F(function (n, r) {
                      E(c(t, { minify: t.minify.enabled }), e)
                        .then(function (t) {
          ...
          .then(function (t) {
            t.map(function (t) {
              try {
                I.insertBefore(t, T ? T.nextSibling : null);
              } catch (e) {
                I.appendChild(t);
              }
            }),
              L.detectingConflicts &&
                T &&
                U(function () {
                  T.setAttributeNode(
                    document.createAttribute(L.detectionIgnoreAttr),
                  );
                  var t = (function (t, e) {
                    var n = document.createElement("script");
                    return (
