...
(function (_) {
   ...
   */ var i = (function (g) {
    var h = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
      ...
      s = {
        ...
        util: {
          encode: function a(e) {
            return e instanceof y
              ? new y(e.type, a(e.content), e.alias)
              : Array.isArray(e)
              ? e.map(a)
              : e
                  .replace(/&/g, "&amp;")
          ...
          objId: function (a) {
            return (
              a.__id || Object.defineProperty(a, "__id", { value: ++b }), a.__id
            );
          },
          clone: function a(e, t) {
            ...
            switch (s.util.type(e)) {
              case "Object":
                if (((r = s.util.objId(e)), t[r])) return t[r];
                (n = {}), (t[r] = n);
          ...
          setLanguage: function (a, e) {
            (a.className = a.className.replace(RegExp(h, "gi"), "")),
              a.classList.add("language-" + e);
          },
          ...
          insertBefore: function (a, e, t, n) {
            ...
            for (var o in r)
              if (r.hasOwnProperty(o)) {
                if (o == e)
                  for (var u in t) t.hasOwnProperty(u) && (l[u] = t[u]);
        ...
        highlightElement: function (a, e, t) {
          ...
          var o = a.textContent,
            u = { element: a, language: n, grammar: r, code: o };
          function d(k) {
            (u.highlightedCode = k),
        ...
        tokenize: function (a, e) {
          ...
          var r = new T();
          return S(r, r.head, a), M(a, r, e, r.head, 0), P(r);
        },
        hooks: {
          all: {},
          add: function (a, e) {
        ...
        if (!(!t.hasOwnProperty(o) || !t[o])) {
          ...
          for (var d = 0; d < u.length; ++d) {
            ...
            var v = u[d],
              ...
              G = !!v.greedy,
              N = v.alias;
            if (G && !v.pattern.global) {
              var Q = v.pattern.toString().match(/[imsuy]*$/)[0];
              v.pattern = RegExp(v.pattern.source, Q + "g");
            }
            for (
              var U = v.pattern || v, m = n.next, A = r;
              ...
              if (!(E instanceof y)) {
                var D = 1,
                  F;
                if (G) {
                  if (((F = C(U, A, a, B)), !F || F.index >= a.length)) break;
                  var I = F.index,
                    ee = F.index + F[0].length,
                    $ = A;
                  for ($ += m.value.length; I >= $; )
                    (m = m.next), ($ += m.value.length);
                  if ((($ -= m.value.length), (A = $), m.value instanceof y))
                    continue;
                  for (
                    var L = m;
                    L !== e.tail && ($ < ee || typeof L.value == "string");
                    L = L.next
                  )
                    D++, ($ += L.value.length);
                  D--, (E = a.slice(A, $)), (F.index -= A);
                } else if (((F = C(U, 0, E, B)), !F)) continue;
                var I = F.index,
                  z = F[0],
                  j = E.slice(0, I),
                  Z = E.slice(I + z.length),
                  H = A + E.length;
                l && H > l.reach && (l.reach = H);
                var O = m.prev;
                j && ((O = S(e, O, j)), (A += j.length)), R(e, O, D);
                var ae = new y(o, k ? s.tokenize(z, k) : z, N, z);
                if (((m = S(e, O, ae)), Z && S(e, m, Z), D > 1)) {
                  var q = { cause: o + "," + d, reach: H };
                  M(a, e, t, m.prev, A, q),
                    l && q.reach > l.reach && (l.reach = q.reach);
                }
              }
            }
          }
            ...
            g.addEventListener(
              ...
              function (a) {
                var e = JSON.parse(a.data),
                  ...
                  n = e.code,
                  r = e.immediateClose;
                g.postMessage(s.highlight(n, s.languages[t], t)),
                  r && g.close();
              },
              !1,
            )),
    ...
    f &&
      ((s.filename = f.src), f.hasAttribute("data-manual") && (s.manual = !0));
    function c() {
  ...
  _.exports && (_.exports = i),
    ...
    Object.defineProperty(i.languages.markup.tag, "addInlined", {
      value: function (h, b) {
        ...
        s["language-" + b] = { pattern: /[\s\S]+/, inside: i.languages[b] };
        var y = {};
        (y[h] = {
          pattern: RegExp(
    ...
    (function (g) {
      ...
      b &&
        (b.tag.addInlined("style", "css"), b.tag.addAttribute("style", "css"));
    })(i),
    (i.languages.clike = {
      comment: [
        {
    ...
    (function () {
      ...
      var g = "Loading…",
        ...
        b = "✖ Error: File does not exist or is empty",
        w = {
          js: "javascript",
          py: "python",
          rb: "ruby",
          ...
          if (c.matches(T)) {
            ...
            n && n.loadLanguages(e),
              S(
                ...
                function (r) {
                  c.setAttribute(s, C);
                  var l = R(c.getAttribute("data-range"));
                  if (l) {
                    var o = r.split(/\r\n?|\n/g),
                      u = l[0],
...
`)),
                ...
                function (r) {
                  c.setAttribute(s, M), (p.textContent = r);
                },
              );
          }
        }),
        (i.plugins.fileHighlight = {
          highlight: function (c) {
            for (
              var p = (c || document).querySelectorAll(T), a = 0, e;
              (e = p[a++]);
...
var le = V.exports;
const K = te(le),
  oe = ue(`<main class="line-numbers h-full w-full text-sm text-white"><style>
          * {
            background: #282C34;
          }
        </style><pre><code class="language-html" id="code" style="white-space:hard-wrap;">`);
function ce() {
  if (!J()) {
    const x =
    ...
    ne(new re(new URL(x, location.toString())));
  }
  const _ = new URLSearchParams(location.search).get("q") ?? "";
  return (
    J()
      ?.fetch(_)
      .then((x) => {
        x.text().then((i) => {
          document.getElementById("code").innerHTML = K.highlight(
            i,
            K.languages.html,
            "html",
          );
    ...
    (() => {
      ...
      return (
        X(
          ...
          Y(ie, {
            get children() {
              return ["view-source:", _];
            },
          }),
          g,
        ),
        X(x, Y(se, { rel: "icon", href: "/icons/earth.svg" }), g),
        x
      );
    })()
  );
